...
const ARTICLES: Article[] = [
  ...
  },
  {
    id: 4,
    date: '2025.01.05',
    title: '業界リーダー企業とのパートナーシップ契約を締結',
    category: '企業情報',
    excerpt:
      '国内外の業界をリードする企業との戦略的パートナーシップを締結し、新たなビジネス展開を開始いたします。',
    readTime: '3分',
    content: `<h2>パートナーシップの意義</h2>
      <p>業界リーダーとの協業により、革新的なソリューション開発と市場拡大を加速させます。</p>
      <h2>期待される効果</h2>
      <p>両社の強みを活かした相乗効果により、顧客価値の最大化を実現いたします。</p>`,
    tags: ['パートナーシップ', '経営', '拡大'],
  },
  {
    id: 5,
    ...
    category: '企業ニュース',
    excerpt:
      '2025年のスタートに際して、無迹探索株式会社の新たなビジョンと経営方針についてお知らせいたします。',
    readTime: '5分',
    content: `<h2>2025年のビジョン</h2>
      <p>日本と中国を架け橋として、グローバルなビジネスソリューション提供企業を目指します。</p>
      <h2>経営方針</h2>
      <p>革新、信頼、共創を基本理念として、ステークホルダーとともに持続可能な価値創造に取り組みます。</p>`,
    tags: ['ビジョン', '経営', '2025'],
  },
]
