        ...
        <section className="py-16 md:py-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              ...
              <h2 className="font-noto-serif-jp text-xl md:text-2xl font-medium text-text-dark mb-6 leading-relaxed drop-shadow-sm">
                日中コーヒービジネスの新たな架け橋
              </h2>
              <div className="w-12 h-px bg-primary/30 mx-auto mb-8"></div>
              <p className="text-sm md:text-base text-text-secondary leading-loose max-w-2xl mx-auto mb-5">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <ScrollReveal delay={100}>
                <div className="p-8 transition-all duration-500 group  hover:shadow-lg">
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollReveal>
              ...
              <div className="w-12 h-px bg-primary/30 mx-auto mb-8"></div>
              <p className="text-xs md:text-sm text-text-secondary/80 mb-10 leading-loose max-w-lg mx-auto">
